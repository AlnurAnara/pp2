...
#snake image
try:
    original_snake_image = pygame.image.load("snake.png")  
    snake_image = pygame.transform.scale(original_snake_image, (CELL_SIZE, CELL_SIZE)) 
except pygame.error as message:
    print("Cannot load image: snake.png")
...
def draw_all():
    ...
    # Draw snake
    for sx, sy in snake:
        win.blit(snake_image, (sx * CELL_SIZE, sy * CELL_SIZE))  # Draw the image
