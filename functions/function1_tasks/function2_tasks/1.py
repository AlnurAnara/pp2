...
print(high_imdb(movies[0]))

#2
'''
Write a function that returns a sublist of movies with an IMDB score above 5.5.
'''
def high_imdb_lists(movie_list):
    return [movie for movie in movie_list if high_imdb(movie)]
print(high_imdb_lists(movies))

#4
'''
Write a function that takes a list of movies and computes the average IMDB score.
'''
def cal_average(movie):
    return len(movie) 
print(cal_average(movies))
...
#5
'''
Write a function that takes a category and computes the average IMDB sco
'''
def average_imdb_by_category(movie_list, category):
    category_movies = movies_by_category(movie_list, category)
    return cal_average(category_movies)
